...
declare class FeatureData {
    ...
    deleteGeoJsonProperties(fieldNames: Array<string>): void;
...
type GmOptionsData = {
    settings: {
        ...
        customGetAllShapeSegments?: (featureData: FeatureData) => SegmentData$1[] | null;
        customVertexUpdateHandler?: (shape: FeatureShape, event: GmEditMarkerMoveEvent) => GeoJsonShapeFeature | null;
        customShapeUpdateHandler?: (featureData: FeatureData, oldLngLat: LngLatTuple, newLngLat: LngLatTuple) => GeoJsonShapeFeature | null;
        customRotateHandler?: (shape: FeatureShape, event: GmEditMarkerMoveEvent) => GeoJsonShapeFeature | null;
    };
